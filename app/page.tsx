...
export const metadata: Metadata = {
  title: 'ECTC 2026 - Emergency Critical Care and Trauma Conference | Kathmandu, Nepal',
  description: 'Join 500+ emergency physicians, nurses, and trauma specialists at ECTC 2026 in Kathmandu, Nepal (March 24-27). Clinical workshops, keynote sessions, hands-on training, and healthcare networking.',
  alternates: {
    canonical: '/',
  },
  openGraph: {
    title: 'ECTC 2026 - Emergency Critical Care and Trauma Conference | Kathmandu, Nepal',
    description: 'Join 500+ emergency physicians, nurses, and trauma specialists at ECTC 2026 in Kathmandu, Nepal. March 24-27, 2026. Clinical workshops, keynotes, and networking.',
    url: '/',
    images: [
      {
        url: '/images/bg.jpg',
        width: 1200,
        height: 630,
        alt: 'ECTC 2026 Emergency Critical Care and Trauma Conference venue in Kathmandu',
      },
    ],
  },
};
...
export default function Home() {
  ...
  const eventJsonLd = {
    ...
    name: 'Emergency Critical Care and Trauma Conference 2026',
    alternateName: 'ECTC 2026',
    description: 'A medical conference focused on emergency medicine, critical care, and trauma management featuring 50+ speakers, workshops, and networking sessions.',
    ...
    image: 'https://ectc2026.org/images/bg.jpg',
    organizer: {
      '@type': 'Organization',
      name: 'ECTC 2026 Organizing Committee',
    ...
    offers: [
      {
        ...
        url: 'https://ectc2026.org/registration',
      },
      {
        '@type': 'Offer',
        name: 'Nurse Pass',
    ...
    audience: {
      ...
      audienceType: 'Emergency physicians, critical care specialists, trauma surgeons, nurses, paramedics, residents, and medical students',
    },
  };
  ...
  const websiteJsonLd = {
    ...
    '@type': 'WebSite',
    name: 'ECTC 2026',
    alternateName: 'Emergency Critical Care and Trauma Conference 2026',
    url: 'https://ectc2026.org',
  };
        ...
        <main>
          ...
          <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
              <Image
                src="/images/bg.jpg"
                alt="ECTC 2026 conference hall at Bhrikutimandap Convention Area, Kathmandu"
                fill
            ...
            <div className="max-w-4xl mx-auto text-center space-y-8 relative z-20">
              ...
              <div className="flex flex-col sm:flex-row gap-8 justify-center items-center py-8">
                <div className="flex items-center gap-3 bg-background/60 backdrop-blur px-6 py-3 rounded-lg border border-primary/20">
                  <MapPin size={20} className="text-accent flex-shrink-0" aria-hidden="true" />
                ...
                <div className="h-px w-12 bg-border hidden sm:block" aria-hidden="true" />
                <div className="flex items-center gap-3 bg-background/60 backdrop-blur px-6 py-3 rounded-lg border border-primary/20">
                  <Calendar size={20} className="text-accent flex-shrink-0" aria-hidden="true" />
                  <div className="text-left">
                    <p className="text-xs text-foreground/60 uppercase tracking-wide">Dates</p>
                    <time dateTime="2026-03-24/2026-03-27" className="text-foreground font-medium">March 24-27, 2026</time>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative h-96 rounded-lg overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="Emergency medicine keynote speaker presenting at ECTC medical conference"
                    fill
                    className="object-cover"
                  />
                </div>
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 bg-secondary/30">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  { src: '/images/networking-event.jpg', alt: 'Healthcare professionals networking at ECTC emergency medicine conference', title: 'Clinical Networking' },
                  { src: '/images/workshop-session.jpg', alt: 'Hands-on trauma resuscitation workshop session at ECTC 2026', title: 'Trauma Workshops' },
                  { src: '/images/attendees-group.jpg', alt: 'Group of emergency care attendees and medical teams at ECTC conference', title: 'Healthcare Teams' },
                ].map((item, idx) => (
